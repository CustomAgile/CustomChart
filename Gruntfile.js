...
module.exports = function (grunt) {
    ...
    grunt.registerTask('pretty-debug', 'Build and deploy app to the location in auth.json', ['template:debugsdk', 'setPostBuildInfo:deploy/App-debug.txt']);
};